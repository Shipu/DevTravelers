<div class="form-group attr-field attr-type-text col-md-12" style="display: none;">
  <label>{{ trans('attribute.default') }} {{ trans('attribute.type.text') }}</label>
...
<div class="form-group attr-field attr-type-textarea col-md-12" style="display: none;">
  <label>{{ trans('attribute.default') }} {{ trans('attribute.type.textarea') }}</label>
...
<div class="form-group attr-field attr-type-date col-md-12" style="display: none;">
  <label>{{ trans('attribute.default') }} {{ trans('attribute.type.date') }}</label>
...
<div class="form-group attr-field attr-type-dropdown col-md-12" style="display: none;">
  <label>{{ trans('attribute.type.multiple_select') }}</label>
  <div class="well">
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                if(type == 'multiple_select') {
                  ...
                  $('.attr-type-dropdown').children('label').html('{{ trans('attribute.type.multiple_select') }}');
                } else {
                  $('.attr-type-dropdown').children('label').html('{{ trans('attribute.type.dropdown') }}');
                }
            ...
            $(document).on('change', '#attribute_type', function () {
                ...
                if(type == 'multiple_select') {
                  ...
                  $('.attr-type-dropdown').find('label').html('{{ trans('attribute.type.multiple_select') }}');
                } else {
                  $('.attr-type-dropdown').find('label').html('{{ trans('attribute.type.dropdown') }}');
                }
